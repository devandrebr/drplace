    				...
    				<div class="container">
    					<div class="row">
    						<div class="col-md-12">
    							...
    							<a class="logo logo-header" href="<?php echo base_url() ?>">
    						...
    						<div class="row">
    							<div class="col-md-10 col-md-offset-1">
    								...
    								<div class="banner-center-box text-white text-center">
    									...
    									<a class="scroll-to btn xx-large colorful hover-dark mt-30" href="#our-services">Crie sua conta</a>
    			...
    			<div id="content-wrap">
    				...
    				<div id="our-services" class="flat-section center-vertical" data-scroll-index="1">
    					<div class="section-content">
                            ...
                            <h4>A Dr.Place</h4>
    												<p>Uma plataforma inovadora justamente pra te ajudara  resolver esse problema que enche o saco e atrasa a vida na hora de anunciar um imóvel.</p>
    											</div>
    										</div>
                            ...
                            <i class="fa fa-eercast"></i>
    											...
    											<div class="box-content">
    												<h4>Crie sua conta hoje mesmo</h4>
    				...
    				<div id="clients-testimonials" class="flat-section" data-scroll-index="2">
                      ...
                      <?php
                        if( $qtd2 <= 0 ) {
                          echo '<p>Nenhum interesse cadastrado até o momento, tente novamente.</p>';
                        } else {
                      ?>
                          ...
                          <?php
                            for($i=0; $i<$qtd2; $i++):
                              ...
                              $nome = mb_strtoupper($res2[$i]['imint_nome']);
                              $msg = mb_strtoupper($res2[$i]['imint_msg']);
                              $data_cad = get_string_data(converte_data($res2[$i]['imint_dataCadastro']));
                              $img = $res2[$i]['usu_foto'];
    							...
    							<div class="container">
    								<div class="row">
    									<div class="col-md-12 text-center">
    										...
    										<a class="scroll-to btn xx-large colorful hover-dark mt-20" href="#our-services">Anuncie Seu Imóvel</a>

  ...
  <div class="container">
      ...
      <div class="row clearfix">
        <div class="col-md-12">
          <h4>
            ...
            <span class="heading">Resultado da Pesquisa por Imóveis</span>
          </h4>
        </div>
      </div>
    </div>
    ...
    <?php
      if( $qtd == 0 )
      {
        $msg = array();
        $msg['status'] = 'info';
        $msg['msg'] = 'Nenhum imóvel localizado para os filtros(parâmetros) informado, tente uma nova pesquisa.';

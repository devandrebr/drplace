...
{
    $date = date( 'Ymd', rand(strtotime('2011-1-1'), time()) );

    $nav = array(
                'Gecko/' . $date . ' Firefox/' . rand( 5, 7 ) . '.0',
                'Gecko/' . $date . ' Firefox/' . rand( 5, 7 ) . '.0.1',
                'Gecko/' . $date . ' Firefox/3.6.' . rand( 1, 20 ),
                'Gecko/' . $date . ' Firefox/3.8'
            );

    $ver = array_random( $nav );
...
function random_uagent( array $lang=array('pt-BR') )
{

<?php
    ...
    class Make_bread_painel
    {
        ...
        public function __construct()
        {
          ...
          $this->_include_home    = $CI->config->item('include_home_painel', 'make_bread');
          $this->_container_open  = $CI->config->item('container_open_painel', 'make_bread');
          $this->_container_close = $CI->config->item('container_close_painel', 'make_bread');
          $this->_divider         = $CI->config->item('divider_painel', 'make_bread');
          $this->_crumb_open      = $CI->config->item('crumb_open_painel', 'make_bread');
          $this->_crumb_close     = $CI->config->item('crumb_close_painel', 'make_bread');
          $this->_crumb_open_home = $CI->config->item('crumb_open_home_painel', 'make_bread');
          $this->_crumb_open_active = $CI->config->item('crumb_open_active_painel', 'make_bread');
